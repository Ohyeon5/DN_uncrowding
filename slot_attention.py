'''
Slot Attention implementation by @lucidrains  https://github.com/lucidrains/slot-attention LISCENCE==MIT

Implementation of Slot Attention from the paper 'Object-Centric Learning with Slot Attention' in Pytorch. 
